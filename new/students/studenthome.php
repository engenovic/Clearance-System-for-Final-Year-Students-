                    ...
                    <div class="col-lg-12">
						...
						<table class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
                                    ...
                                    <?php
									$clearance=mysqli_query($con,"select * from department_hod where idnumber='$username'");
									$data=mysqli_fetch_array($clearance);
									$clearancestatus=$data['clearance_status'];
									$basket=$data['basket'];
									if($clearancestatus==1)
									...
									<?php
									$clearance=mysqli_query($con,"select * from department_ict where idnumber='$username'");
									$data=mysqli_fetch_array($clearance);
									$clearancestatus=$data['clearance_status'];
									$basket=$data['basket'];
									if($clearancestatus==1)
